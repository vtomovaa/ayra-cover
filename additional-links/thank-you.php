...
<body>
    <div class="image-logo-1">
        <img src="../i" class="logo-1" />
    </div>
    <hr />
    <div class="div-wrapper">

        <div class="image-product">
            <img src="https://lesthe.com/cdn/onycostop/covers_assets/w2409-m-1-antiFungix/images/Image 1.webp" class="product" />
        </div>

        <div class="header-name">
            <p class="name-product">EternaGlow Radiance Cream</p>
